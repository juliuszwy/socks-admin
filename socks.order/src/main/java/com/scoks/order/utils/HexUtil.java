...
public class HexUtil {
     ...
     * @return 加密内容
     */
    private static byte[] encrypt(String secretKey,String content) {
        try {
     ...
     * @return 解密内容
     */
    private static byte[] decrypt(String secretKey,String contents) {
        try {
            //密文使用Hex解码
     ...
     * @return 加密内容
     */
    public static String  encryption(String secretKey,String context) {
        //加密后的明文也就变成了密文
        byte[] encryptResult = encrypt(secretKey,context);
        //密码文Hex编码
     ...
     * @return 解密内容
     */
    public static String decryption(String secretKey,String context) {
        //这里的密文解密前先进行了Hex解码
        byte[] decryptResult = decrypt(secretKey,context);
